    ...
    try {
        const [rows] = await db.query(
            `SELECT 
                ...
                (SELECT COUNT(*) FROM marker WHERE color = 'orange') AS orange_count,
                (SELECT COUNT(*) FROM marker WHERE color = 'purple') AS purple_count,
        ...
        res.json({
            ...
            orange_count: rows[0].orange_count,
            purple_count: rows[0].purple_count,
